...
class Heap{
	...
	public void updateHeap(int nodeNumber,int newDistance){
...
class Graph{
    ...
    public int[] calculateMinDistance(int startNode){
    	...
    	while(count!=numberOfNodes){
    		...
    		if(node.distance!=Integer.MAX_VALUE){
	    		...
	    		for(int i=0;i<children.size();i++){
	    			...
	    			int newDistance = node.distance+child.distance;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        while(T>0){
        	...
        	int [] distance = graph.calculateMinDistance(startNode);
